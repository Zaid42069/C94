...
export default class MeteorScreen extends Component {
    ...
    getMeteors = () => {
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=8XDPcV7GRSIVxKfrAy8zqCj23xeUUyo3uCdly0Gr")
            .then(response => {
...
return(
    <View>
       ...
       <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>Misses earth by (km)-{item.close_approach_data[0].miss_distance.kilometers}</Text>
        </View>
